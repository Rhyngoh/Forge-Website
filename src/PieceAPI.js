const PieceAPI = {
	pieces: [
		{ number: 1, name: 'Basic Piece 1', link: 'Basic-Piece-1', description: 'sample description' },
		{ number: 2, name: 'Basic Piece 2', link: 'Basic-Piece-2', description: 'sample description' },
		{ number: 3, name: 'Basic Piece 3', link: 'Basic-Piece-3', description: 'sample description' },
		{ number: 4, name: 'Basic Piece 4', link: 'Basic-Piece-4', description: 'sample description' },
